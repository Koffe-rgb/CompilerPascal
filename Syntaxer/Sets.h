#ifndef COMPILERPASCAL_SETS_H
#define COMPILERPASCAL_SETS_H
...
const auto follow_simpleExpression  = set<TokenCodes> { TokenCodes::equal, latergreater, later, latergreater, TokenCodes::greater, greaterequal };
